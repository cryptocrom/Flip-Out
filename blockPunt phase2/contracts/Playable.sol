...
contract Playable is Ownable, Destroyable, usingProvable, Accountable, Winnable, Randomisable {

    //FlipOut game function
    ...
    //DrawOut game from here onwards
    ...
    function convert(uint256 n) private pure returns (bytes32) {        //takes uint and spits out bytes32 - this is for DrawOut house card
        return bytes32(n);
    }
